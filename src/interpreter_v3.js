...
function special_value_object(value){
	var obj = {};
	obj.tag = "special_value";
	object.value = value;
}
...
function add_key_value_pair(key, value, table, row){
	...
	} else if(is_number(value) || is_string(value) || is_boolean(value) || is_undefined_value(value)){
		object = primitive_object(value);
	} else if(is_pair(value) || is_empty_list(value)){
